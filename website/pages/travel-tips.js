...
export default function TravelTips(props) {
    const foodguides = props.foodguides
    return(
        <div>
            <Head>
                <title> Travel Tips - The Layover Life</title>
            ...
            style={{paddingTop:'1vh'}}>
                <Grid item align="center" md={12} style={{marginBottom:"5vh",position:'relative'}}>
                    <Typography variant="h3" style={{marginBottom:'2vh'}}> Travel Tips</Typography>
...
TravelTips.getInitialProps = async() => {
    //get the list of travel guides and packing guides
    const res = await Promise.all([getPostsByCategory('travel-tips',6)])
